...
from ctypes import OleDLL, WinDLL, windll, c_ulong, byref, WINFUNCTYPE, POINTER, c_char_p, c_void_p, c_long
...
def CoCreateInstanceFromFactory(factory_ptr, iid_interface=pythoncom.IID_IDispatch, pUnkOuter=None):
    ...
    print(factory_ptr.value)
    print(pythoncom.IID_IClassFactory)
...
def CoDllGetClassObject(dll_filename, clsid_class, iid_factory=pythoncom.IID_IClassFactory):
    ...
    dll = windll.LoadLibrary(dll_filename)
    # dll = WinDLL(dll_filename)
